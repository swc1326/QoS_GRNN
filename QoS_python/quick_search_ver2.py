...
if __name__ == '__main__':
    ...
    experiment = [55.0, 55.0, 55.0, 55.0, 55.0, 55.0, 55.0, 55.0, 60.0, 60.0, 65.0, 65.0, 70.0, 70.0, 75.0, 75.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0]
    ...
    train_y = [[-12.5], [-10], [-10], [-5], [-10], [-10], [-5], [-5], [-5], [0], [0], [7.5], [7.5], [7.5]]
    sigma = 20.0
    max_x, max_y =50, 70
    ...
    for current_run in experiment: #len(experiment) = 40
        ...
        while p <= max_x:
            while q <= max_y:
                if (pkt_loss >= r and (p + q > allocated_BW)) or (pkt_loss < r and (p + q < allocated_BW)):
